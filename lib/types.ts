...
export type CrmSnapshot = {
  ...
  /*
   * Acciones ejecutadas desde el tablero (Cola de hoy / Cliente 360°):
   * trazabilidad para medir qué sugerencia convierte. Solo lectura.
   */
  actions?: CrmActionRow[];
};
...
/*
 * COLA DE HOY (playlists): jugadas accionables para el CRM.
 */
